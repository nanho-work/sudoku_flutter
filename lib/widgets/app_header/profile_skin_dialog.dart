          ...
          return GestureDetector(
              ...
              if (unlocked) {
                ...
                switch (result) {
                  case PurchaseResult.success:
                    ...
                    // ✅ 로컬 즉시 반영
                    await context.read<SkinController>().setUnlocked(
                    ...
                    // ✅ 백엔드 동기화 (비동기)
                    unawaited(context.read<SkinController>().loadAll(
                      FirebaseAuth.instance.currentUser!.uid,
                    ));
            ...
            child: Stack(
              children: [
                ...
                if (!unlocked && item.unlockCost > 0 && item.unlockType != 'default')
                  Positioned(
                    bottom: 6,
                    left: 6,
                    right: 6,
